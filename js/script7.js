...
let data_info = async () => {
    ...
    let info = `<h2 id="id">City: ${City}</h2><br>
   <h2 style="color:orange;">Temp: ${t1}­°C</h2></h2><br><br>
   <h2 style="color:blue;">Humidity: ${h1} </h2><br>
    <h2 style="color:green;">Weather: ${d1} <div class="im1"><img src="${i}" width="100" height="100" style="border-radius: 30px;"></div></h2>`
